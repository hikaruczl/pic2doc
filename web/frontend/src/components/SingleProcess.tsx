...
import { Provider, TaskResult, uploadSingle, getTask, getDownloadUrl } from '../api/client';
...
export default function SingleProcess({ provider }: { provider: Provider }) {
  ...
  const downloadUrl = useMemo(() => result ? getDownloadUrl(result.output_path) : '', [result]);
    ...
    <>
      ...
      {result && (
        <div className="result">
          ...
          <a className="primary download-btn" href={downloadUrl} target="_blank" rel="noreferrer">
